...
let g:dracula#palette.bgdarker  = ['#130f13', 244]
"let g:dracula#palette.bgdarker  = ['#191A21', 234]

let g:dracula#palette.comment   = ['#8191C3',  61]
"let g:dracula#palette.comment   = ['#6272A4',  61]
let g:dracula#palette.selection = ['#44475A', 239]
let g:dracula#palette.subtle    = ['#424450', 238]

let g:dracula#palette.cyan      = ['#64E4FF', 117]
let g:dracula#palette.green     = ['#16FF4D',  84]
let g:dracula#palette.orange    = ['#FFB86C', 215]
let g:dracula#palette.pink      = ['#FF43B4', 200]
let g:dracula#palette.purple    = ['#B86EFF', 141]
let g:dracula#palette.red       = ['#FF3030', 203]
let g:dracula#palette.yellow    = ['#F2FE67', 228]

"let g:dracula#palette.cyan      = ['#8BE9FD', 117]
"let g:dracula#palette.green     = ['#50FA7B',  84]
"let g:dracula#palette.orange    = ['#FFB86C', 215]
"let g:dracula#palette.pink      = ['#FF52CD', 200]
...
" ANSI
"
let g:dracula#palette.color_0  = '#130f13'
let g:dracula#palette.color_1  = '#ff3030'
let g:dracula#palette.color_2  = '#16ff4d'
let g:dracula#palette.color_3  = '#f2fe67'
let g:dracula#palette.color_4  = '#b86eff'
let g:dracula#palette.color_5  = '#ff43b4'
let g:dracula#palette.color_6  = '#64e4ff'
let g:dracula#palette.color_7  = '#F8F8F2'
let g:dracula#palette.color_8  = '#515d82'
let g:dracula#palette.color_9  = '#fd5b5b'
let g:dracula#palette.color_10 = '#69ff94'
let g:dracula#palette.color_11 = '#ffffa5'
let g:dracula#palette.color_12 = '#c68bff'
let g:dracula#palette.color_13 = '#ff79d8'
let g:dracula#palette.color_14 = '#6effff'
let g:dracula#palette.color_15 = '#FFFFFF'

"let g:dracula#palette.color_0  = '#0C0015'
